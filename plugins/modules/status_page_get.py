...
EXAMPLES = r'''
# Get all the available status pages.
- name: Get all the available status pages.
  betteruptime.betteruptime.status_page_get:
    api_token: <api_token>
  register: resp

# Print all the available status pages.
- name: Print all the available status pages.
  debug:
    var: resp
'''
